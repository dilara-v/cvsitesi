...
const templates = [
  {
    ...
    image: "/pembe.jpg", // İlk şablon için pembe.jpg kullanıldı
  },
  {
    id: 2,
          ...
          <div className="template-grid">
            {filteredTemplates.map((template) => (
              <div key={template.id} className="template-card">
                ...
                <p><strong>Etiketler:</strong> {template.tags.join(', ')}</p>
                <button
